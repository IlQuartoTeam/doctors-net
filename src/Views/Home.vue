<template>
        ...
        <div
            ...
            <div class="title text-center text-md-start position-relative">
                ...
                <div class="pills position-absolute d-none d-xxl-block">
                    <ThreeObject w="300" h="150" yRot="0.5" xRot="-0.01" far="10" ambLight="0" kebab="true"
                        kebabSpeed="0.001" directLight="3" path="/threeObjects/pills-blue.gltf" />
                </div>
                <div class="register z-1 position-absolute d-none d-xxl-block">
                    <ThreeObject w="300" h="150" yRot="0.5" xRot="-0.01" isRotOnMouse="true" ambLight="4"
                        rotOnMouse="0.00008" directLight="1" path="/threeObjects/medicalRecord-mod.gltf" />
                </div>
            </div>
        </div>
        <div class="searchBar ">
    ...
    <div class="separator w-100">
        <svg class="waves w-100" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120"
            preserveAspectRatio="none">
            <path
                d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z"
                class="shape-fill" fill="#2FB0BD" fill-opacity="1"></path>
        </svg>
    </div>
