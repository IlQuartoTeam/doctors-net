<template>
     <div class="modal-wrap">
        <div class="doc-modal p-4">
          <h1 class="text-center text-doc-blue fs-2 fw-bold">Stai acquistando</h1>
          <p class="ps-2 text-center text-doc-blue fs-4 fw-bold">{{ store.payment.subscription + '   (' +store.payment.hours+ ')' + '  -   '+ store.payment.price }}€</p>
      ...
      easier to manage -->
      <ButtonComponent id="payment-button" :button="true" type="submit" className="primary">Aggiungi carta</ButtonComponent>
      <ButtonComponent  @click="store.payMode = false" :button="false" className="btn outline  ms-3">Annulla</ButtonComponent>
